...
print(apiURL);
   ...
   static Future<PublikModel> layananDetail(String id) async {
    // final LocalStorage storage = new LocalStorage('auth');
    String apiURL = globalBaseUrl + "public/layanan/" + id;
print(apiURL);
    await GeneralModel.token().then((value) {
      tokenFixed = value.res;
    });
    ...
    print('tampilan layanan detail status code : ' +
        apiResult.statusCode.toString());
    Map jsonObject = json.decode(apiResult.body);
    String message = jsonObject.containsKey('message')
        ? jsonObject['message'].toString()
  ...
  static Future<PublikModel> orderLayanan(String id) async {
    // final LocalStorage storage = new LocalStorage('auth');
    String apiURL = globalBaseUrl + "public/layanan/" + id+'/order';
print(apiURL);
    await GeneralModel.token().then((value) {
      tokenFixed = value.res;
    });
    ...
    print('order layanan status code : ' +
        apiResult.statusCode.toString());
    Map jsonObject = json.decode(apiResult.body);
    String message = jsonObject.containsKey('message')
        ? jsonObject['message'].toString()
